...
TokenModule = __decorate([
    (0, common_1.Module)({
        imports: [database_module_1.DatabaseModule, (0, common_1.forwardRef)(() => auth_module_1.AuthModule), client_module_1.ClientModule],
        controllers: [token_controller_1.TokenController],
        providers: [...token_providers_1.tokenProviders, token_service_1.TokenService],
